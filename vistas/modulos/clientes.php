      ...
      <form role="form" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA LA MOTILADA GRATIS -->
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" min="0" class="form-control input-lg" name="gratis" placeholder="1 activo 0 desactivado">
...
<div id="modalCompraGratis" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Compra Gratis</h4>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" min="0" class="form-control input-lg" name="documentoIdFree" id="documentoIdFree">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="email" class="form-control input-lg" name="emailFree" id="emailFree">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="telefonoFree" id="telefonoFree" data-inputmask="'mask':'(999) 999-9999'" data-mask required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="direccionFree" id="direccionFree" >
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="fechaNacimientoFree" id="fechaNacimientoFree"  data-inputmask="'alias': 'yyyy/mm/dd'" data-mask>
        ...
        <?php
          ...
          $clienteFree = new ControladorClientes();
          $clienteFree -> ctrCompraGratis();
