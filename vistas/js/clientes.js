...
COMPRA GRATIS
=============================================*/
$(".tablas").on("click", ".btnGratis", function(){
    ...
    $.ajax({
      ...
      success:function(respuesta){
      	...
      	$("#idClienteFree").val(respuesta["id"]);
	       $("#clienteFree").val(respuesta["nombre"]);
	       $("#documentoIdFree").val(respuesta["documento"]);
	       $("#emailFree").val(respuesta["email"]);
